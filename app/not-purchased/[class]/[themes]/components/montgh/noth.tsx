      ...
      <div className="w-full h-full grid 2xl:grid-cols-4 xl:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 grid-rows-1 gap-6 mt-2">
        {
          items.map((item, index) => (
            <Link href={"#"} style={{ fontFamily: "cursive" }} key={index} className='resource-class bg-gray-2 dark:bg-form-strokedark items-center gap-3 shadow hover:shadow-md transition-all p-4 rounded-md'>
