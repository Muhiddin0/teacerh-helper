  ...
  return (
    <>
      <div className="grid grid-cols-1 xl:grid-cols-2 grid-rows-1 gap-8">
        <Link className="my-resource-card flex flex-col-reverse md:flex-row items-center md:items-start justify-between gap-3 p-5 rounded-md shadow-3 hover:shadow-6 transition bg-white dark:bg-black" href={pathname + '/exact-science'}>
